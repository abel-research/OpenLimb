...
component[0] = random.choice(np.linspace(-0.645328929043159 , 0.4273670099841691, 100))
component[1] = random.choice(np.linspace(-0.31931947079786 , 0.72298577328671, 100))
component[2] = random.choice(np.linspace(-0.531048773913778 , 0.56827592399203, 100))
component[3] = random.choice(np.linspace(-0.46741046041567 , 0.490646382465809, 100))
component[4] = random.choice(np.linspace(-0.507896845719971 , 0.588489283542763, 100))
component[5] = random.choice(np.linspace(-0.549559768779508 , 0.534364309153956, 100))
component[6] = random.choice(np.linspace(-0.638809195801619 , 0.527485323330151, 100))
component[7] = random.choice(np.linspace(-0.3986621998533641 , 0.41065896977363, 100))
component[8] = random.choice(np.linspace(-0.389913947175072 , 0.599926073881045, 100))
component[9] = random.choice(np.linspace(-0.587790496589690 , 0.622085661222956, 100))
