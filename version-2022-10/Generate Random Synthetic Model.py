...
component[0] = random.choice(np.linspace(-0.645875688308391, 0.4270985256116332, 100))
component[1] = random.choice(np.linspace(-0.3174567817931260, 0.72284292658389, 100))
component[2] = random.choice(np.linspace(-0.530385195453453, 0.568480311211345, 100))
component[3] = random.choice(np.linspace(-0.475353494355143, 0.4892511082041, 100))
component[4] = random.choice(np.linspace(-0.511894761882895, 0.592749280399389, 100))
component[5] = random.choice(np.linspace(-0.548177774707646, 0.539242729550059, 100))
component[6] = random.choice(np.linspace(-0.649058497957105, 0.526965505263899, 100))
component[7] = random.choice(np.linspace(-0.404963659762407, 0.40850407848520714, 100))
component[8] = random.choice(np.linspace(-0.3873422202462439, 0.60087564085551, 100))
component[9] = random.choice(np.linspace(-0.589923661583772, 0.61931384907782, 100))
