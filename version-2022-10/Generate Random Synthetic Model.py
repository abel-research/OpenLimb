...
component[0] = random.choice(np.linspace(-0.645136177579207 , 0.427468398941479, 100))
component[1] = random.choice(np.linspace(-0.319562675124794 , 0.721351741564590, 100))
component[2] = random.choice(np.linspace(-0.531144638989158 , 0.56824776489518, 100))
component[3] = random.choice(np.linspace(-0.465319971776664 , 0.4934452816001631, 100))
component[4] = random.choice(np.linspace(-0.506268600858749 , 0.586924919057129, 100))
component[5] = random.choice(np.linspace(-0.546863163690846 , 0.534412022291594, 100))
component[6] = random.choice(np.linspace(-0.637987186556472 , 0.53682127586837, 100))
component[7] = random.choice(np.linspace(-0.4101942925240679 , 0.4172928988535315, 100))
component[8] = random.choice(np.linspace(-0.388328070409842 , 0.590402041425709, 100))
component[9] = random.choice(np.linspace(-0.590590647720516 , 0.612981467156495, 100))
